...
{
    public class Produto :Entity, IAgregationRoot
    {
        protected Produto()
        {
        }
        ...
        public void DebitarEstoque(int quantidade)
        {
            ...
            if (!PussuiEstoque(quantidade))
            {
                throw new DomainException("Estoque insulficiente");
            }
        ...
        public void Validar()
        {
            ...
            Validacoes.ValidarSeigualMinimo(Valor, 0, "O campo valor do produto não pode ser igual a 0");
